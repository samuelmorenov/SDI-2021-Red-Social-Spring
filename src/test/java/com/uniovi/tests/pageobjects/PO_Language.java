...
public class PO_Language {
	...
	static public void checkChangeIdiom(String message) {
		...
		PO_HomeView.changeIdiom(RU);
		PO_View.checkKey(message, PO_Properties.getRUSSIAN());
	...
	static public void checkChangeIdiom(String message1, String message2) {
		...
		PO_HomeView.changeIdiom(RU);
		PO_View.checkKey(message1, PO_Properties.getRUSSIAN());
		PO_View.checkKey(message2, PO_Properties.getRUSSIAN());
		PO_HomeView.changeIdiom(EN);
